    ...
    override fun getInjection(context: PsiElement): Injection? {
        ...
        if (context.elementType == SimplatesTypes.CODE_BLOCK) {
            ...
            if (context.parent?.elementType == SimplatesTypes.ANNOTATED_CODE_BLOCK) {
                val annotation = context.parent.children.firstOrNull { it.elementType == SimplatesTypes.ANNOTATION } ?: throw IllegalStateException("Annotated code block element is missing an annotation children")
